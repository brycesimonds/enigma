...
## Ruby Conventions and Mechanics => "Meets Expectations/Above Expectations (3.75)"
...
- A couple methods are longer than 10 lines long
...
- My code is DRY and made for developer empathy. It goes beyond the meet expectations, but not quite full blown Above Expectations so 3.75 it is!
...
## **Final Grade for Enigma => 3.3125.ceil(2)**
